...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        """
        # Mark cell as move and safe(if not already)
        self.moves_made.add(cell)
        if cell not in self.safes:
            self.mark_safe(cell)

        # Make new sentence and add it to knowledge
